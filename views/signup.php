        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-12">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex items-center space-x-4">
                    <a href="/CoachPro/views/login.php" class="text-[#1A1A1A] hover:text-[#D4896D] font-medium">Login</a>
                </div>
            </div>
        </div>
    </nav>
        ...
        <div class="max-w-xl w-full py-16">
            ...
            <div class="bg-white border border-gray-300 p-10">
                <form method="POST" action="/CoachPro/controllers/signupcontroller.php" class="space-y-6">
                    ...
                    <div>
                        <label for="role" class="block text-sm font-medium text-[#1A1A1A] mb-2">I want to sign up as</label>
                        <select
                            id="role"
                            name="role"
                            required
